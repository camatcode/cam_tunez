defmodule Tunez.Accounts.User do
  ...
  alias AshAuthentication.Strategy.Password.RequestPasswordReset
  ...
  actions do
    ...
    update :change_password do
      ...
      validate {PasswordValidation, strategy_name: :password, password_argument: :current_password}
    ...
    read :sign_in_with_token do
      ...
      prepare SignInWithTokenPreparation
    ...
    action :request_password_reset_token do
      ...
      run {RequestPasswordReset, action: :get_by_email}
    end
