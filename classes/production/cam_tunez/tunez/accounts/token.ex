defmodule Tunez.Accounts.Token do
  ...
  alias AshAuthentication.TokenResource.GetTokenPreparation
  alias AshAuthentication.TokenResource.IsRevoked
  alias AshAuthentication.TokenResource.RevokeAllStoredForSubjectChange
  alias AshAuthentication.TokenResource.RevokeJtiChange
  alias AshAuthentication.TokenResource.RevokeTokenChange
  alias AshAuthentication.TokenResource.StoreTokenChange
  ...
  actions do
    ...
    update :revoke_all_stored_for_subject do
      ...
      accept [:extra_data]
      argument :subject, :string, allow_nil?: false, sensitive?: true
      change RevokeAllStoredForSubjectChange
    end
  end
